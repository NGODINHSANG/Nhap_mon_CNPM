...
//    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("NgÃ y thÃ¡ng nÄƒm sinh:");
        ...
        jLabel4.setText("Giá»›i tÃ­nh:");

        jLabel13.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel13.setText("TÃ´n giÃ¡o:");
        ...
        jLabel17.setText("Há»™ chiáº¿u sá»‘:");

        jLabel19.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel19.setText("Ä�á»‹a chá»‰ hiá»‡n táº¡i:");

        jLabel20.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel20.setText("NÆ¡i thÆ°á»�ng trÃº:");
        ...
        jLabel24.setText("TrÃ¬nh Ä‘á»™ chuyÃªn mÃ´n:");
        ...
        jLabel26.setText("TrÃ¬nh Ä‘á»™ há»�c váº¥n:");

        jLabel27.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel27.setText("TrÃ¬nh Ä‘á»™ ngoáº¡i ngá»¯:");
        ...
        jLabel29.setText("Biáº¿t tiáº¿ng dÃ¢n tá»™c:");
        ...
        jLabel33.setText("NÆ¡i lÃ m viá»‡c:");
    ...
    private void CreateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateBtnActionPerformed
        if (validateValueInForm()) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(rootPane, "CÃ³ lá»—i xáº£y ra. Vui long kiá»ƒm tra láº¡i!!", "Warning", JOptionPane.WARNING_MESSAGE);
            }
        }
    ...
    private boolean validateValueInForm() {
        ...
        if (hoTenTxb.getText().trim().isEmpty() 
            ...
            JOptionPane.showMessageDialog(rootPane, "Vui lÃ²ng nháº­p háº¿t cÃ¡c trÆ°á»�ng báº¯t buá»™c", "Warning", JOptionPane.WARNING_MESSAGE);
            return false;
        }
        ...
        try {
                ...
                JOptionPane.showMessageDialog(rootPane, "Sá»‘ CMT khÃ´ng thá»ƒ chá»©a cÃ¡c kÃ½ tá»±", "Warning", JOptionPane.WARNING_MESSAGE);
                return false;
            }
        // kiem tra do dai cmt
        if (soCMTTxb.getText().length() != 9 && soCMTTxb.getText().length() != 12) {
            JOptionPane.showMessageDialog(rootPane, "Vui lÃ²ng nháº­p Ä‘Ãºng Ä‘á»‹nh dáº¡ng CMT", "Warning", JOptionPane.WARNING_MESSAGE);
            return false;
        }
        return true;
    }
